...
import * as sty from "./PlasmicTextInput.module.css"; // plasmic-import: 3xLYAsovFYjh/css
import SearchIcon from "./icons/PlasmicIcon__Search"; // plasmic-import: A6u7xdH0pyLU/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchIcon
                className={classNames(projectcss.all, sty.svg___1OHaw)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <CheckIcon
                className={classNames(projectcss.all, sty.svg__d6T8R)}
                role={"img"}
              />
            ),
