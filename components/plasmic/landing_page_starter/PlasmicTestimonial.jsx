...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: zwc6F9r4_dw2/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__x3KrJ)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__tjNpt)}
      >
        <p.PlasmicImg
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__itKd)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__z7Cyr)}>
            {p.renderPlasmicSlot({
